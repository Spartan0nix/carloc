 ...
 */
final class Version20210425204408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" ALTER last_name TYPE VARCHAR(80)');
        $this->addSql('ALTER TABLE "user" ALTER first_name TYPE VARCHAR(80)');
